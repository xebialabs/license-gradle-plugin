= License Gradle Plugin (Digital.ai Fork)
:license_plugin_version: 0.17.0

[IMPORTANT]
====
This is a fork of the original https://github.com/hierynomus/license-gradle-plugin[license-gradle-plugin] by Jeroen van Erp.

This fork is maintained by Digital.ai for use in its products. For the original plugin, please visit the upstream repository.
====
...
=== Using the Digital.ai fork
This Digital.ai fork is published to internal Nexus repository.
...
buildscript {
  ...
  dependencies {
    classpath "com.xebialabs.gradle.plugins:license-gradle-plugin:{license_plugin_version}"
  }
}
...
=== Using the original plugin (Gradle 2.1+)
If you prefer to use the original hierynomus version from the Gradle Plugin Portal:
...
For older Gradle versions with the original plugin:
...
=== com.xebialabs.license-base Plugin

[source,groovy,subs="verbatim,attributes"]
----
plugins {
  id "com.xebialabs.license-base" version"{license_plugin_version}"
}
----
...
=== com.xebialabs.license Plugin

[source,groovy,subs="verbatim,attributes"]
----
plugins {
  id "com.xebialabs.license" version"{license_plugin_version}"
}
----

This plugin will apply the following plugins:

- `com.xebialabs.license-base`
- `com.xebialabs.license-report`
...
----
plugins {
  id "com.xebialabs.license-report" version"{license_plugin_version}"
}
----
