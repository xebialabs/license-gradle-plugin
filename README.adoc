= License Gradle Plugin (XebiaLabs Fork)
...
This fork is maintainedS-126555 by XebiaLabs for use in Digital.ai products. For the original plugin, please visit the upstream repository.
====
